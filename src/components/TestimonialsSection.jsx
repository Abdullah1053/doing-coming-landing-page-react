...
const TestimonialsSection = () => {
    ...
    return (
        <section
            ref={sectionRef}
            className={`site-section py-24 transition-all duration-700 md:translate-y-8 ${isInView ? 'translate-y-0 opacity-100' : ''}`}
            id="testimonials"
        >
                    ...
                    <div className="relative -mx-20">
                        <div ref={carouselRef} className="testimonials-carousel">
                            {testimonials.map((testimonial) => (
                                <div key={testimonial.id} className="carousel-cell w-[60%] px-4 mx-4 transition-all duration-300">
                                    <div className="flex flex-col items-center justify-center text-center">
                                        <div className="mb-12">
                                            ...
                                            <div className="text-center opacity-60 group-[&.is-selected]:opacity-100 transition-opacity duration-300">
                                                <p className="text-xl font-semibold text-white mb-1">{testimonial.name}</p>
                                                <p className="text-base text-white/60">{testimonial.role}</p>
                                            </div>
                                        </div>
