...
function SparklesPreview() {
  return (
    <div className="h-[40rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md -mt-[250px]">
      <h6 className="md:text-7xl text-3xl lg:text-9xl font-bold text-center text-white relative z-20 h-40 w-70 mb-[118px]">
        <img src="assets/img/logo/DOING WHITE_converted.avif" alt="doing logo" width={400} height={400}/>
      </h6>
