...
const TemplatesSection = () => {
  ...
  const templates = [
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M40 12h-8V8c0-2.21-1.79-4-4-4h-8c-2.21 0-4 1.79-4 4v4H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V16c0-2.21-1.79-4-4-4zm-20-4h8v4h-8V8zm20 36H8V16h8.01c0 1.1.89 2 1.99 2h12c1.1 0 2-.9 2-2H40v28z"
          />
          <path
            fill="url(#custom-templates-gradient)"
            d="M24 28h-8v-2h8v2zm8-6H16v-2h16v2zm0-6H16v-2h16v2z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M14 36h20v-4H14v4zm0-8h20v-4H14v4zM14 8v4h20V8H14zm-4 28q-.825 0-1.412-.587Q8 34.825 8 34V14q0-.825.588-1.413Q9.175 12 10 12h28q.825 0 1.413.587Q40 13.175 40 14v20q0 .825-.587 1.413Q38.825 36 38 36H10z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M13.5 21.5h21v-3h-21v3zm0 7h21v-3h-21v3zM8 42q-1.25 0-2.125-.875T5 39V9q0-1.25.875-2.125T8 6h18.5L40 19.5V39q0 1.25-.875 2.125T37 42H8zm18-24.75V9H8v30h29V19.5H26V17.25z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M8 42q-1.25 0-2.125-.875T5 39V9q0-1.25.875-2.125T8 6h32q1.25 0 2.125.875T43 9v30q0 1.25-.875 2.125T40 42H8zm0-3h15V25H8v14zm18 0h14v-7H26v7zm0-10h14v-7H26v7zM8 22h32v-8H8v8z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M15.95 35.5h6.1v-15h-6.1v15zm0-18h6.1v-5h-6.1v5zm10 18h6.1v-5h-6.1v5zm0-8h6.1v-15h-6.1v15zM7 44q-1.2 0-2.1-.9Q4 42.2 4 41V7q0-1.2.9-2.1Q5.8 4 7 4h34q1.2 0 2.1.9.9.9.9 2.1v34q0 1.2-.9 2.1-.9.9-2.1.9H7z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="m11.65 44 3.25-14.05L4 20.5l14.4-1.25L24 6l5.6 13.25L44 20.5l-10.9 9.45L36.35 44 24 36.55 11.65 44zm12.35-10.55 7.85 4.75-1.85-8.9 6.9-6-9.1-.8L24 14.2l-3.8 8.3-9.1.8 6.9 6-1.85 8.9 7.85-4.75z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M24 4C12.95 4 4 12.95 4 24s8.95 20 20 20 20-8.95 20-20S35.05 4 24 4zm0 36c-8.84 0-16-7.16-16-16S15.16 8 24 8s16 7.16 16 16-7.16 16-16 16zm-2-26h4v12h-4V14zm0 16h4v4h-4v-4z"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M36 4H12C9.79 4 8 5.79 8 8v32c0 2.21 1.79 4 4 4h24c2.21 0 4-1.79 4-4V8c0-2.21-1.79-4-4-4zm0 36H12V8h24v32zM16 12h16v4H16v-4zm0 8h16v4H16v-4zm0 8h12v4H16v-4z"
          />
        </svg>
      ),
      title: "Blog Section",
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M38 4H10C7.79 4 6 5.79 6 8v32c0 2.21 1.79 4 4 4h28c2.21 0 4-1.79 4-4V8c0-2.21-1.79-4-4-4zm0 36H10V8h28v32zm-4-24H14v-4h20v4zm0 8H14v-4h20v4zm-8 8H14v-4h12v4z"
          />
        </svg>
      ),
      title: "Blog Intros",
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            fill="url(#custom-templates-gradient)"
            d="M38 4H10C7.79 4 6 5.79 6 8v32c0 2.21 1.79 4 4 4h28c2.21 0 4-1.79 4-4V8c0-2.21-1.79-4-4-4zm0 36H10V8h28v32zm-4-8H14v-4h20v4zm0-8H14v-4h20v4zm0-8H14v-4h20v4z"
          />
        </svg>
      ),
  ...
  return (
    <section
      ref={sectionRef}
      className={`site-section py-20 transition-all duration-700 md:translate-y-8 lg:py-24 ${
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-3 gap-4 max-lg:grid-cols-2 max-md:grid-cols-1">
          {templates.map((template, index) => (
            <div
              key={template.id}
              className={`group relative z-2 flex-col rounded-3xl p-1 px-10 pt-10 transition-all duration-300 ${
                index > 5 && !showMore ? "hidden" : "flex"
              }`}
            >
              ...
              <div className="relative z-1 transition-all duration-300 group-hover:-translate-y-20">
                ...
                <h5 className="mb-6">{template.title}</h5>
                <p className="mb-10 text-white/80">{template.description}</p>
              </div>
              ...
              <div className="group/link absolute bottom-0 end-10 start-10 z-1 flex h-20 -translate-y-20 items-center overflow-hidden transition-all duration-300 group-hover:translate-y-0">
                <a
                  className="flex h-full w-full translate-y-20 items-center justify-between gap-2 border-t border-white/20 text-sm font-semibold text-white transition-all duration-300 hover:text-primary group-hover:translate-y-0"
                  href="#templates"
                >
