      ...
      <div className="relative">
        <div className="container mb-24">
          <div className="mx-auto w-2/3 text-center max-lg:w-10/12 max-sm:w-full">
            <p
              ...
              className="-from-[5%] mb-10 inline-block bg-gradient-to-br from-white from-30% to-white/70 bg-clip-text font-heading text-[82px] font-bold leading-none tracking-tight text-transparent max-sm:text-[18vw]"
            >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 text-sm">
              <a
                className="relative inline-flex w-56 gap-3 overflow-hidden whitespace-nowrap rounded-lg bg-gradient-to-r from-blue-300 to-blue-500 to-50% py-5 font-semibold text-primary-foreground transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-primary/20"
                href="#"
              >
                <span
              ...
              <a
                className="group/btn flex items-center gap-2 text-white transition-colors hover:text-primary"
        ...
        <div className="container mb-20">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-4">
            {socialLinks.map((social, index) => (
              <a
                key={index}
                className="group flex flex-col items-center rounded-2xl px-4 pb-8 pt-10 text-center leading-tight text-white/50 transition-all hover:scale-105 hover:text-white"
                href="#"
              >
                <span className="mb-8 block">{social.icon}</span>
        ...
        <div className="container">
          <div className="flex flex-wrap items-center justify-between gap-8 py-14 max-sm:justify-center">
            <a href="index.html">
              <img
                src="./assets/img/logo/HESz--magicai-logo.svg"
                alt="MagicAI logo"
              />
            </a>
            <ul className="flex flex-wrap items-center justify-end gap-7 text-sm max-sm:justify-center"></ul>
          </div>
