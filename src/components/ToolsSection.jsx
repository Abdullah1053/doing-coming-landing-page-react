...
const ToolsSection = () => {
    ...
    const tabs = [
        { id: 'tools-payment-gateways', label: 'تجارة إلكترونية', image: './assets/img/tools/payment-gateways.jpg', title: 'تجارة إلكترونية', description: 'Securely process credit card or other electronic payment methods.' },
        { id: 'tools-multilingual', label: 'اعمال', image: './assets/img/tools/multilingual.jpg', title: 'اعمال', description: 'Ability to understand and generate content in different languages.' },
        { id: 'tools-affiliate-system', label: 'مطاعم', image: './assets/img/tools/affiliate-system.jpg', title: 'مطاعم', description: 'Ability to invite friends, and earn commission from their first purchase.' },
        { id: 'tools-easy-export', label: 'مدونة', image: './assets/img/tools/easy-export.jpg', title: 'مدونة', description: 'Export generated content as plain text, PDF, Word or HTML easily.' },
        { id: 'tools-support-platform', label: 'منظمات خيرية', image: './assets/img/tools/support-platform.jpg', title: 'منظمات خيرية', description: 'Access and mage support tickets from your dashboard.' }
    ];

    const renderTabContent = (tab) => (
        <div key={tab.id} id={tab.id} className={activeTab === tab.id ? '' : 'hidden'}>
    ...
    return (
        <section
            ref={sectionRef}
            className={`site-section py-20 transition-all duration-700 md:translate-y-8 opacity-0 lg:pb-24 lg:pt-16 ${isInView ? 'translate-y-0 opacity-100' : ''}`}
        >
            <div className="container">
                <header className="mx-auto mb-20 w-full text-center lg:w-4/5">
                    ...
                    <p className="m-0 mx-auto text-xl/7 text-white/80 lg:w-9/12">
                        Glide gives you the powers of a developer and a code — for designer to create remarkable tools that
                    ...
                    {tabs.map(tab => (
                        <button
                            ...
                            className={`group/trigger flex text-base max-sm:w-full px-3 py-3.5 rounded-full max-mdbasis-1/3 max-md:grow text-center justify-center transition-all md:px-8 text-white/60 hover:text-white hover:scale-105 ${
                                activeTab === tab.id ? 'lqd-is-active bg-heading-foreground/10 !text-white' : ''
                            }`}
