...
function App() {
  ...
  return (
    ...
    >
        ...
        <div className="container">
          <div className="grid grid-cols-2 gap-8">
            <div className="flex flex-col justify-center">
              ...
              <p className="mt-4 text-xl leading-7 text-gray-800 dark:text-white/80">
            ...
            >
              <div className="flex items-center">
                <div className="h-12 w-12 flex items-center justify-center">
                  <FontAwesomeIcon className="w-8 h-8 text-sky-500" icon={item.icon} />
                </div>
                <div className="mr-5">
      ...
      {/* Start Journy */}
      <section className="container mt-20">
        <div className="grid grid-cols-2 rounded-2xl overflow-hidden h-[380px]">
          <div>
            <iframe
          ...
          <div className="flex flex-col justify-center bg-gradient-to-r from-cyan-500 to-cyan-700 p-8">
            ...
            <button className="mt-5 text-right">ابدأ تجارتك الآن</button>
          </div>
        </div>
      </section>
      {/* End Journy */}
      ...
      <section className="container mt-20">
        ...
        <dl className="mt-16 grid grid-cols-4 gap-5">
          {features.map((item) => (
            <div
              key={item.name}
